...
<section class="section">
    <div class="section-header">
        ...
        <div class="ml-auto">
            ...
            <form action="{{ route('rekap-pemasukan.getData') }}" method="GET" style="display: inline;">
                <input type="hidden" name="export_excel" value="true">
                <input type="hidden" name="opsi" id="hidden-select-cabang">
            ...
            <div class="col-md-3">
                <div class="card card-success">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        @elseif($pemasukanHariIni < $pemasukanKemarin) @if($pemasukanKemarin> 0)
            ...
            <div class="col-md-3">
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        ...
                        @elseif ($pemasukanBulanIni < $pemasukanBulanLalu) <span class="badge badge-danger"><i class="fa far fa-arrow-down"></i> {{ number_format((($pemasukanBulanLalu - $pemasukanBulanIni) / $pemasukanBulanLalu) * 100, 2) }}%</span>
                            @else
                            <span class="badge badge-secondary">Sama</span>
                            @endif
...
<script>
    $(document).ready(function() {
        ...
        function loadData(){
            ...
            $('#hidden-select-cabang').val(selectedOption); // Set hidden input value

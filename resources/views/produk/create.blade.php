          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <div class="alert alert-danger mt-2 d-none" role="alert" id="alert-kode_produk"></div>
              </div>

              <div class="form-group">
                <label>Nama Produk</label>
                <input type="text" class="form-control" name="nama_produk" id="nama_produk">
                <div class="alert alert-danger mt-2 d-none" role="alert" id="alert-nama_produk"></div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="number" class="form-control" aria-label="Username" aria-describedby="addon-wrapping" name="hpp" id="hpp">
                </div>
                <div class="alert alert-danger mt-2 d-none" role="alert" id="alert-hpp"></div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  <span class="input-group-text" id="addon-wrapping">Rp</span>
                  <input type="number" class="form-control" aria-label="Username" aria-describedby="addon-wrapping" name="harga_jual" id="harga_jual">
                </div>
              ...
              <div class="form-group">
                <label>Cabang</label>
                <select class="form-control" name="cabang_id" id="cabang_id" style="width: 100%">

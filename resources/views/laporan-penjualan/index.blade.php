...
<div class="section-header">
        ...
        <div class="ml-auto">
            <!-- Button to trigger printing the report as PDF -->
            <a href="javascript:void(0)" class="btn btn-danger" id="print-laporan-penjualan">
                <i class="fa fa-sharp fa-light fa-print"></i> Print PDF
            </a>

            <!-- Form to export the report as Excel -->
            <form action="{{ url('/laporan-penjualan/get-data') }}" method="GET" id="export-excel-form" style="display:inline;">
                <!-- Add fields here as needed -->
                <input type="hidden" name="export_excel" value="1">
                <button type="submit" class="btn btn-success ml-2">
                    <i class="fa fa-sharp fa-light fa-file-excel"></i> Export to Excel
                </button>
            </form>
        </div>
    </div>
            ...
            <div class="col-md-3">
                <div class="card card-success">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        @elseif($transaksiHariIni < $transaksiKemarin) @if ($transaksiKemarin> 0)
            ...
            <div class="col-md-3">
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        ...
                        <span class="badge badge-success"><i class="fa far fa-arrow-up"></i> Naik</span>
                        @endif
                        @elseif($transaksiHariIni < $transaksiBulanLalu) @if ($transaksiBulanLalu> 0)
    ...
    $(document).ready(function() {
        ...
        $('#print-laporan-penjualan').on('click', function() {
            ...
            $.ajax({
                ...
                data: {
                    print_pdf: true
                }, // Mengirimkan parameter print_pdf sebagai true
                success: function(response) {
                    if (response.success) {
        ...
        $('#export-excel-form').submit(function(event) {
        event.preventDefault();
        ...
        var url = '/laporan-penjualan/exportExcel?opsi=' + selectedOption + '&tanggal_mulai=' + tanggalMulai + '&tanggal_selesai=' + tanggalSelesai;

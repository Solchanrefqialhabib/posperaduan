...
Route::middleware('auth', 'filterCabang')->group(function () {
    ...
    Route::group(['middleware' => 'checkRole:administrator,kepala restoran,admin'], function () {
        ...
        Route::get('laporan-penjualan/exportExcel', [LaporanPenjualanController::class, 'exportExcel'])->name('laporan-penjualan.exportExcel');
        Route::get('/laporan-penjualan/print-laporan-penjualan', [LaporanPenjualanController::class, 'getData']);
        ...
        Route::get('rekap-pemasukan/get-data', [RekapPemasukanController::class, 'getData'])->name('rekap-pemasukan.getData');
        ...
        // Route::get('/kategori/get-data', [KategoriController::class, 'getData']);
        // Route::get('/kategori', [KategoriController::class, 'index']);

        // Route::resource('/kategori', KategoriController::class);

        // Route::get('/produk/get-data', [ProdukController::class, 'getData']);
    ...
    Route::group(['middleware' => 'checkRole:administrator,kasir'], function () {
        Route::resource('/menu-kasir', MenuKasirController::class);
        Route::post('/menu-kasir', [PembelianController::class, 'pembelian'])->name('pembelian');
        Route::post('/menu-kasir/paid', [PembelianController::class, 'updateStatusPembayaran'])->name('updateStatusPembayaran');
    });
});
